...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/muddle.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/muddle)
...
```bash
php artisan vendor:publish --tag="muddle-migrations"
php artisan migrate
```
